...
function PaginationLink({
  ...
  return (
    <a
      ...
      className={cn(
        "glass inline-flex items-center justify-center rounded-md text-sm transition-all duration-200",
        ...
        size === "default" && "h-9 gap-1 px-3",
        isActive &&
          "border border-primary-500/30 bg-primary-500/10 text-primary-300",
        !isActive && "border border-transparent text-muted-foreground",
        className
      )}
      {...props}
    />
