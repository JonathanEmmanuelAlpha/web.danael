...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "glass-card mb-2 overflow-hidden rounded-lg border border-border",
        "last:mb-0",
        className
      )}
      {...props}
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between gap-4 rounded-md px-4 py-4 text-left text-sm font-medium transition-all duration-200",
          "hover:bg-surface-3",
