...
import { LifeBuoy, KeyRound, ArrowRight } from "lucide-react";
...
/**
 * §5.2 — support onboarding: authorization code activation.
 */
export default function SupportOnboardingPage() {
  const t = useTranslations("Onboarding.support");
