...
/**
 * §5.2 — content_moderator onboarding: authorization code activation.
 */
export default function ContentModeratorOnboardingPage() {
  const t = useTranslations("Onboarding.contentModerator");
